...
- (void) updateBirdWithImage:(UIImage *) image {
    SKTexture* birdTexture1 = [SKTexture textureWithImage:image];
    birdTexture1.filteringMode = SKTextureFilteringNearest;
    SKTexture* birdTexture2 = [SKTexture textureWithImage:image];
    birdTexture2.filteringMode = SKTextureFilteringNearest;
    SKTexture* birdTexture3 = [SKTexture textureWithImage:image];
    birdTexture2.filteringMode = SKTextureFilteringNearest;
//    self = [BirdNode spriteNodeWithTexture:birdTexture1];
...
- (void) bounce
{
    ...
    NSLog(@"resetVelocity = %f", resetVelocity);
    NSLog(@"newVeloc = %f", newVeloc);
    resetVelocity = 0;
