...
#define TS_INTERSTITIAL_AD_UNIT_ID @"5407769ae4b02053be050e24"
#define TS_INTERSITITAL_FREQUENCY 5
...
- (id)initWithSize:(CGSize)size {
    if (self = [super initWithSize:size]) {
        ...
        self.tsInterstitial = [[TapSenseInterstitial alloc] initWithAdUnitId:TS_INTERSTITIAL_AD_UNIT_ID];
...
{
    if (gamesPlayed % TS_INTERSITITAL_FREQUENCY == 0){
